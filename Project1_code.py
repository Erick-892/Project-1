...
st.title("Proyecto 1, cálculo de Value-at-Risk y de Expected Shortfall.")
...
if st.sidebar.button("Calcular"):
    with st.spinner("Procesando datos..."):
        ...
        # -------------------------------------------------------------------------
        st.subheader("Análisis Rolling Windows de VaR y ES")
        ...
        # -------------------------------------------------------------------------
        st.subheader("Análisis de Violaciones")
